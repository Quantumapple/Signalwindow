...
// Mon Jul  1 21:54:16 2019 by ROOT version 6.16/00
...
Int_t mySw::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mySw::LoadTree(Long64_t entry)
{
...
void mySw::StorePixelHit(int region){
