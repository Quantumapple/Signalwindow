...
void SW::Loop()
{
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        //if( propgenElPartPhi->size() == 0 ) continue;
        ...
        //cout << "Fourth layer hits: " << fourth_layer_hits.size() << endl;
        ...
        // pixel3 pixel4
        //
        //cout << "Event: " << jentry << ", " << fourth_layer_hits.size() << endl << endl;
        for(unsigned long i = 0; i < third_layer_hits.size(); i++){
            for(unsigned long j = 0; j < fourth_layer_hits.size(); j++){
