...
int TMVAClassification_R6(TString myMethodList = "")
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start TMVAClassification_R6" << std::endl;

   // Register the training and test trees
   // Monte Carlo - Signal Sample data input
   TFile* signalfile = new TFile("inputs/tmva_input_r6_sig.root");
   ...
   TFile* datafile = new TFile("inputs/tmva_input_r6_bkg.root");
   ...
   TString outfileName( "output_R6.root" );
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("Dataset_R6");
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
       "nTrain_Signal=9030:nTrain_Background=45597:SplitMode=Random:NormMode=NumEvents:!V" );
...
//---------------------------------------------------------------------------------------------------------------------------------
   ...
   std::cout << "==> TMVAClassification_R6 is done!" << std::endl;
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_R6(methodList);
}
