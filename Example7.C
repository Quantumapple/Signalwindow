...
void AnalyseEvents(ExRootTreeReader *treeReader, TFile *result, TTree *tt)
{
    ...
    for(entry = 0; entry < allEntries; ++entry)
    {
        ...
        for(unsigned int k = 0; k < branchParticle->GetEntriesFast(); k++)
        {
            ...
            j11 = particle->PT;
            k11 = fmod(j11 , 0.002);
            if(fabs(k11) < 0.001) genPT = j11 - k11;
            else{
                if(j11 < 0) genPT = j11 - k11 - 0.002;
                else genPT = j11 - k11 + 0.002;
            }
            //particle->Eta
            j11 = particle->Eta;
            k11 = fmod(j11 , 0.002);
            if(fabs(k11) < 0.001) genEta = j11 - k11;
            else{
                if(j11 < 0) genEta = j11 - k11 - 0.002;
                else genEta = j11 - k11 + 0.002;
            }
            //particle->Phi
            j11 = particle->Phi;
            k11 = fmod(j11 , 0.002);
            if(fabs(k11) < 0.001) genPhi = j11 - k11;
            else{
                if(j11 < 0) genPhi = j11 - k11 - 0.002;
                else genPhi = j11 - k11 + 0.002;
            }
        ...
        for(unsigned int k = 0; k < repeat; k++)
        {
            ...
            if( fabs(eCalTrack->EtaOuter) <= 3.0)
            {
				...
				j11 = egVector.Et();
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) eCalEt = j11 - k11;
				else{
					if(j11 < 0) eCalEt = j11 - k11 - 0.002;
					else eCalEt = j11 - k11 + 0.002;
				}
				//eCalTrack->EtaOuter
				j11 = eCalTrack->EtaOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) eCalEta = j11 - k11;
				else{
					if(j11 < 0) eCalEta = j11 - k11 - 0.002;
					else eCalEta = j11 - k11 + 0.002;
				}
				//eCalTrack->PhiOuter
				j11 = eCalTrack->PhiOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) eCalPhi = j11 - k11;
				else{
					if(j11 < 0) eCalPhi = j11 - k11 - 0.002;
					else eCalPhi = j11 - k11 + 0.002;
				}
				//eCalTrack->XOuter
				j11 = eCalTrack->XOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) eCalX = j11 - k11;
				else{
					if(j11 < 0) eCalX = j11 - k11 - 0.002;
					else eCalX = j11 - k11 + 0.002;
				}
				//eCalTrack->YOuter
				j11 = eCalTrack->YOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) eCalY = j11 - k11;
				else {
					if(j11 < 0) eCalY = j11 - k11 - 0.002;
					else eCalY = j11 - k11 + 0.002;
				}
				//eCalTrack->ZOuter
				j11 = eCalTrack->ZOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) eCalZ = j11 - k11;
				else{
					if(j11 < 0) eCalZ = j11 - k11 - 0.002;
					else eCalZ = j11 - k11 + 0.002;
				}
        ...
        for(unsigned int k = 0; k < branchPixelL1->GetEntriesFast(); k++)
		{
			...
			if( fabs(trackL1->ZOuter) < 200 )
			{
				...
				j11 = trackL1->ZOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) L1Z = j11 - k11;
				else{
					if(j11 < 0) L1Z = j11 - k11 - 0.002;
					else L1Z = j11 - k11 + 0.002;
				}
		...
		for(unsigned int k = 0; k < branchPixelD1->GetEntriesFast(); k++)
		{
                ...
                //if( fabs(trackD1->ZOuter) > 248 )
			{
				...
				j11 = trackD1->XOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D1X = j11 - k11;
				else{
					if(j11 < 0) D1X = j11 - k11 - 0.002;
					else D1X = j11 - k11 + 0.002;
				}
				//trackD1->YOuter
				j11 = trackD1->YOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D1Y = j11 - k11;
				else{
					if(j11 < 0) D1Y = j11 - k11 - 0.002;
					else D1Y = j11 - k11 + 0.002;
				}
				//trackD1->ZOuter
				j11 = trackD1->ZOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D1Z = j11 - k11;
				else{
					if(j11 < 0) D1Z = j11 - k11 - 0.002;
					else D1Z = j11 - k11 + 0.002;
				}
		...
		for(unsigned int k = 0; k < branchPixelD2->GetEntriesFast(); k++)
		{
                ...
                //if( fabs(trackD2->ZOuter) > 315 )
			{
				...
				j11 = trackD2->XOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D2X = j11 - k11;
				else{
					if(j11 < 0) D2X = j11 - k11 - 0.002;
					else D2X = j11 - k11 + 0.002;
				}
				//trackD2->YOuter
				j11 = trackD2->YOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D2Y = j11 - k11;
				else{
					if(j11 < 0) D2Y = j11 - k11 - 0.002;
					else D2Y = j11 - k11 + 0.002;
				}
				//trackD2->ZOuter
				j11 = trackD2->ZOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D2Z = j11 - k11;
				else{
					if(j11 < 0) D2Z = j11 - k11 - 0.002;
					else D2Z = j11 - k11 + 0.002;
                }
		...
		for(unsigned int k = 0; k < branchPixelD3->GetEntriesFast(); k++)
		{
				...
				//if( fabs(trackD3->ZOuter) > 407 )
			{
				...
				j11 = trackD3->XOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D3X = j11 - k11;
				else{
					if(j11 < 0) D3X = j11 - k11 - 0.002;
					else D3X = j11 - k11 + 0.002;
				}
				//trackD3->YOuter
				j11 = trackD3->YOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D3Y = j11 - k11;
				else{
					if(j11 < 0) D3Y = j11 - k11 - 0.002;
					else D3Y = j11 - k11 + 0.002;
				}
				//trackD3->ZOuter
				j11 = trackD3->ZOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D3Z = j11 - k11;
				else{
					if(j11 < 0) D3Z = j11 - k11 - 0.002;
					else D3Z = j11 - k11 + 0.002;
                }
		...
		for(unsigned int k = 0; k < branchPixelD4->GetEntriesFast(); k++)
		{
				...
				//if( fabs(trackD4->ZOuter) > 521 )
			{
				...
				j11 = trackD4->XOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D4X = j11 - k11;
				else{
					if(j11 < 0) D4X = j11 - k11 - 0.002;
					else D4X = j11 - k11 + 0.002;
				}
				//trackD4->YOuter
				j11 = trackD4->YOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D4Y = j11 - k11;
				else{
					if(j11 < 0) D4Y = j11 - k11 - 0.002;
					else D4Y = j11 - k11 + 0.002;
				}
				//trackD4->ZOuter
				j11 = trackD4->ZOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D4Z = j11 - k11;
				else{
					if(j11 < 0) D4Z = j11 - k11 - 0.002;
					else D4Z = j11 - k11 + 0.002;
                }
		...
		for(unsigned int k = 0; k < branchPixelD5->GetEntriesFast(); k++)
		{
				...
				//if( fabs(trackD5->ZOuter) > 667 )
			{
				...
				j11 = trackD5->XOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D5X = j11 - k11;
				else{
					if(j11 < 0) D5X = j11 - k11 - 0.002;
					else D5X = j11 - k11 + 0.002;
				}
				//trackD5->YOuter
				j11 = trackD5->YOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D5Y = j11 - k11;
				else{
					if(j11 < 0) D5Y = j11 - k11 - 0.002;
					else D5Y = j11 - k11 + 0.002;
				}
				//trackD5->ZOuter
				j11 = trackD5->ZOuter;
				k11 = fmod(j11 , 0.002);
				if(fabs(k11) < 0.001) D5Z = j11 - k11;
				else{
					if(j11 < 0) D5Z = j11 - k11 - 0.002;
					else D5Z = j11 - k11 + 0.002;
                }
...
void Example7(const char *inputFile)
{
	...
	TFile *result = new TFile("L1X_modified_by_Example7.root","RECREATE");
